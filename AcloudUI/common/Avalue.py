...
# cm5=(By.XPATH, "//div[@x-placement='bottom-start']//div[@class='el-scrollbar__bar is-vertical']")
cm5=(By.XPATH, "//div[@x-placement='bottom-start']//div[@class='el-scrollbar__bar is-vertical']//div[@class='el-scrollbar__thumb']")
# cm5 = (By.XPATH, "//div[@x-placement='bottom-start']//div[@class='el-scrollbar__bar is-vertical'] | //div[@x-placement='bottom-start']//div[@class='el-scrollbar__bar is-vertical']//div[@class='el-scrollbar__thumb']")
# cm6=(By.XPATH,'//span[text()="A2号标准版"]')
cm6=(By.XPATH,"//span[contains(text(),'至尊版年卡')]")
# cm7=(By.XPATH,'/html/body/div[3]/div/div[2]/form/div[2]/div/div/div[1]/input')
cm7=(By.XPATH,"//div[@class='el-input el-input--medium el-input--suffix']//input[@placeholder='请选择']")
# cm8=(By.XPATH,"//div[@x-placement='bottom-start']//div[@class='el-scrollbar__bar is-vertical']//div[@class='el-scrollbar__thumb']")
# cm9=(By.XPATH,'//span[text()="不限时小时卡2"]')
cm9=(By.XPATH,"(//span[contains(text(),'至尊版年卡')])[2]")
cm10=(By.XPATH,"//body/div[@class='el-dialog__wrapper']/div[@aria-label='分配云机']/div[@class='el-dialog__footer']/div[@class='dialog-footer']/button[1]/span[1]")
cm11=(By.XPATH,"//body[1]/div[1]/div[1]/div[2]/section[1]/div[1]/div[9]/div[1]/div[3]/span[1]/button[2]/span[1]")
...
# cm17=(By.XPATH,"//div[@x-placement='bottom-start']//div[@class='el-scrollbar__bar is-vertical']")
cm17=(By.XPATH,"//div[@x-placement='bottom-start']//div[@class='el-scrollbar__bar is-vertical']//div[@class='el-scrollbar__thumb']")
# cm18=(By.XPATH,'//span[text()="A2号标准版"]')
cm18=(By.XPATH,"//span[contains(text(),'至尊版年卡')]")
cm19=(By.XPATH,"//div[@class='el-input el-input--medium el-input--suffix']//input[@placeholder='请选择']")
# cm20=(By.XPATH,'//div[@class="el-scrollbar__thumb" and @style="transform: translateY(0%); height: 73.0114%;"]')
# cm20=(By.XPATH,"//div[@x-placement='top-start']//div[@class='el-scrollbar__bar is-vertical']//div[@class='el-scrollbar__thumb']")
# cm20=(By.XPATH,"//div[@x-placement='bottom-start']//div[@class='el-scrollbar__bar is-vertical']//div[@class='el-scrollbar__thumb']")
# cm20=(By.XPATH,"//div[@x-placement='bottom-start']//div[@class='el-scrollbar__bar is-vertical']//div[@class='el-scrollbar__thumb']")
cm20 = (By.XPATH, "//div[@x-placement='top-start' or @x-placement='bottom-start']//div[@class='el-scrollbar__bar is-vertical']//div[@class='el-scrollbar__thumb']")
# cm21=(By.XPATH,'//span[text()="不限时小时卡2"]')
cm21=(By.XPATH,"//div[contains(@class,'el-select-dropdown') and contains(@x-placement,'start')]//ul/li[1]")
# cm22=(By.XPATH,"//body/div[@class='el-dialog__wrapper']/div[@aria-label='续期云机']/div[@class='el-dialog__footer']/div[@class='dialog-footer']/button[1]/span[1]")
cm22=(By.XPATH,"(//span[contains(text(),'确 定')])[9]")
cm23=(By.XPATH,"(//span[contains(text(),'确 定')])[5]")
# cm23=(By.XPATH,'//div[3]//span[1]//button[1]//span[1]')
...
cm28=(By.XPATH,"//button[@class='el-button el-picker-panel__link-btn el-button--default el-button--mini is-plain']//span[contains(text(),'确定')]")
cm29=(By.XPATH,'//span[text()="修 改"]')

#查看云机详情
cm30=(By.XPATH,"(//span[contains(text(),'查看')])[1]")
cm31=(By.XPATH,"//div[@aria-label='云机详情']//i[@class='el-dialog__close el-icon el-icon-close']")

#释放云机
cm32=(By.XPATH,'//span[text()="释放"]')
cm33=(By.XPATH,"//button[contains(@class,'el-button el-button--default el-button--small el-button--primary')]//span[contains(text(),'确定')]")
...
product18=(By.XPATH,"(//input[@placeholder='全部'])[2]")
...
redeemcode5=(By.XPATH,"//div[@x-placement='bottom-start']//div[@class='el-scrollbar__bar is-vertical']//div[@class='el-scrollbar__thumb']")
...
redeemcode8=(By.XPATH,"//div[@x-placement='bottom-start']//div[@class='el-scrollbar__bar is-vertical']")
# redeemcode9=(By.XPATH,'//span[text()="不限时小时卡"]')
redeemcode9= (By.XPATH, '//span[contains(text(), "不限时小时卡")]')
...
privilege6=(By.XPATH,"//input[@name='file']")
...
membermenu5=(By.XPATH,"//div[@x-placement='bottom-start']//div[@class='el-scrollbar__bar is-vertical']//div[@class='el-scrollbar__thumb']")
# membermenu5=(By.XPATH,'//div[@style="transform: translateY(0%); height: 37.1387%;"]')
# membermenu6=(By.XPATH,'//li[text()=" A2号标准版(100025622) "]')
membermenu6=(By.XPATH,"//li[contains(text(),'A2号标准版(528467)')]")
...
membermenu8=(By.XPATH,"//div[@x-placement='bottom-start']//div[@class='el-scrollbar__bar is-vertical']")
# membermenu8=(By.XPATH,'//div[@style="transform: translateY(0%); height: 73.0114%;"]')
# membermenu9=(By.XPATH,'//li[text()="不限时小时卡2(100066998672)"]')
membermenu9=(By.XPATH,"//li[contains(text(),'不限时小时卡2(567638)')]")
...
adverse9=(By.XPATH,"//input[@name='file']")
adverse10=(By.XPATH,'//*[@id="unchange"]/div/div/div[1]/input')
# adverse11=(By.XPATH,"//li[@class='el-select-dropdown__item selected hover']//span[contains(text(),'禁用')]")
adverse11=(By.XPATH,"//li[contains(@class,'el-select-dropdown__item selected hover')]//span[contains(text(),'禁用')]")
...
adverse13=(By.XPATH,"//span[contains(text(),'编辑')]")
...
adverse16=(By.XPATH,"//button[contains(@class,'el-button el-button--text el-button--mini')]//span[contains(text(),'删除')]")
adverse17=(By.XPATH,"//span[contains(text(),'确定')]")

#新增配置
config1=(By.XPATH,'//span[text()="配置管理"]')
config2=(By.XPATH,'//li[text()="版本配置"]')
config3=(By.XPATH,"//div[@statusoptions='[object Object],[object Object]']//span[contains(text(),'新增')]")
...
# config10=(By.XPATH,"//div[@x-placement='top-start']//span[contains(text(),'自研版本安卓')]")
# config10=(By.XPATH,"//div[@x-placement='bottom-start']//span[contains(text(),'自研版本安卓')]")
config10 = (By.XPATH, "//div[@x-placement='top-start' or @x-placement='bottom-start']//span[contains(text(),'自研版本安卓')]")
...
config11=(By.XPATH,"(//input[@placeholder='请选择'])[4]")
...
config16=(By.XPATH,"//div[@statusoptions='[object Object],[object Object]']//span[contains(text(),'搜索')]")
...
#编辑配置
config17=(By.XPATH,"(//span[contains(text(),'编辑')])[2]")
config18=config4
...
config19=(By.XPATH,"//div[contains(@aria-label,'编辑版本配置')]//span[contains(text(),'取 消')]")

#删除配置
config20=(By.XPATH,"(//span[contains(text(),'删除')])[4]")
config21=(By.XPATH,"//span[contains(text(),'确定')]")
...
guide4=(By.XPATH,"//input[@name='file']")
...
guide7=(By.XPATH,"//body/div[@id='app']/div[contains(@class,'app-wrapper openSidebar')]/div[contains(@class,'main-container')]/section[contains(@class,'app-main')]/div[contains(@class,'app-container w3c guidepage')]/div[contains(@class,'el-dialog__wrapper')]/div[contains(@aria-label,'添加引导')]/div[contains(@class,'el-dialog__body')]/form[contains(@class,'el-form update-model-form')]/div[contains(@class,'el-form-item el-form-item--mini')]/div[contains(@class,'el-form-item__content')]/div[contains(@class,'tree-wrapper')]/div[contains(@role,'tree')]/div[1]/div[1]/label[1]/span[1]/span[1]")
...
lingxi5=(By.XPATH,"//input[@name='file']")
...
# OSadverse8=(By.XPATH,"//li[@class='el-select-dropdown__item hover']//span[contains(text(),'普通广告')]")
OSadverse8=(By.XPATH,"//li[@class='el-select-dropdown__item hover' or @x-placement='bottom-start']//span[contains(text(),'普通广告')]")
...
OSadverse11_2=(By.XPATH,"//input[@name='file']")#上传图片
...
theme4=(By.XPATH,"(//input[@name='file'])[1]")
theme5=(By.XPATH,"(//input[@name='file'])[2]")
...
wallpaper4=(By.XPATH,'//input[@name="file"]')
...
widget6=(By.XPATH,'//input[@name="file"]')
widget7=OSadverse12
...
application3=(By.XPATH,"(//input[@name='file'])[1]")
application4=(By.XPATH,'//input[@placeholder="请输入应用名称"]')
# application5=(By.XPATH,'//div[@class="el-upload el-upload--picture-card"]')
application5=(By.XPATH,"(//input[@name='file'])[2]")
application6=(By.XPATH,"//span[contains(text(),'确 定')]")
